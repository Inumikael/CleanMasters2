...
function AppProvider({ children }) {
    ...
    const fetchCrews = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[fetchCrews]": async ()=>{
            try {
                setCrews(await api("/api/crews"));
            } catch  {}
        }
    }["AppProvider.useCallback[fetchCrews]"], []);
    const fetchClients = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[fetchClients]": async ()=>{
            try {
                setClients(await api("/api/clients"));
            } catch  {}
        }
    }["AppProvider.useCallback[fetchClients]"], []);
    const fetchAppointments = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[fetchAppointments]": async (filters)=>{
            try {
                const params = filters ? `?${new URLSearchParams(filters)}` : "";
                const data = await api(`/api/appointments${params}`);
                setAppointments((Array.isArray(data) ? data : []).map({
                    "AppProvider.useCallback[fetchAppointments]": (a)=>({
                            ...a,
                            date: toDateOnly(a.date ?? new Date())
                        })
                }["AppProvider.useCallback[fetchAppointments]"]));
            } catch  {}
        }
    }["AppProvider.useCallback[fetchAppointments]"], []);
    const fetchSettings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[fetchSettings]": async ()=>{
            try {
                setSettings(await api("/api/settings"));
            } catch  {}
        }
    }["AppProvider.useCallback[fetchSettings]"], []);
    ...
    const addCrew = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[addCrew]": async (crew)=>{
            await api("/api/crews", {
                method: "POST",
    ...
    }["AppProvider.useCallback[addCrew]"], [
        fetchCrews
    ]);
    const updateCrew = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[updateCrew]": async (id, data)=>{
    ...
    }["AppProvider.useCallback[updateCrew]"], [
        fetchCrews
    ]);
    const deleteCrew = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[deleteCrew]": async (id)=>{
            await api(`/api/crews/${id}`, {
                method: "DELETE"
            });
            await fetchCrews();
        }
    }["AppProvider.useCallback[deleteCrew]"], [
        fetchCrews
    ]);
    const addCrewMember = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[addCrewMember]": async (crewId, data)=>{
    ...
    }["AppProvider.useCallback[addCrewMember]"], [
        fetchCrews
    ]);
    const updateCrewMember = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[updateCrewMember]": async (id, data)=>{
    ...
    }["AppProvider.useCallback[updateCrewMember]"], [
        fetchCrews
    ]);
    const deleteCrewMember = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[deleteCrewMember]": async (id)=>{
            await api(`/api/crew-members/${id}`, {
                method: "DELETE"
            });
            await fetchCrews();
        }
    }["AppProvider.useCallback[deleteCrewMember]"], [
        fetchCrews
    ]);
    const addClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[addClient]": async (client)=>{
            try {
    ...
    }["AppProvider.useCallback[addClient]"], [
        fetchClients
    ]);
    const updateClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[updateClient]": async (id, data)=>{
    ...
    }["AppProvider.useCallback[updateClient]"], [
        fetchClients
    ]);
    const deleteClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[deleteClient]": async (id)=>{
            await api(`/api/clients/${id}`, {
                method: "DELETE"
            });
            await fetchClients();
        }
    }["AppProvider.useCallback[deleteClient]"], [
        fetchClients
    ]);
    const addClientImage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[addClientImage]": async (clientId, imageUrl)=>{
            const client = clients.find({
                "AppProvider.useCallback[addClientImage].client": (c)=>c.id === clientId
            }["AppProvider.useCallback[addClientImage].client"]);
            if (!client) return;
    ...
    }["AppProvider.useCallback[addClientImage]"], [
        clients,
        fetchClients
    ]);
    const removeClientImage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[removeClientImage]": async (clientId, imageIndex)=>{
            const client = clients.find({
                "AppProvider.useCallback[removeClientImage].client": (c)=>c.id === clientId
            }["AppProvider.useCallback[removeClientImage].client"]);
            if (!client?.images?.[imageIndex]) return;
            const newImages = client.images.filter({
                "AppProvider.useCallback[removeClientImage].newImages": (_, i)=>i !== imageIndex
            }["AppProvider.useCallback[removeClientImage].newImages"]);
            await api(`/api/clients/${clientId}`, {
                method: "PUT",
                body: JSON.stringify({
                    images: newImages
    ...
    }["AppProvider.useCallback[removeClientImage]"], [
        clients,
        fetchClients
    ]);
    const addAppointment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[addAppointment]": async (apt)=>{
    ...
    }["AppProvider.useCallback[addAppointment]"], [
        fetchAppointments
    ]);
    const updateAppointment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[updateAppointment]": async (id, data)=>{
    ...
    }["AppProvider.useCallback[updateAppointment]"], [
        fetchAppointments
    ]);
    const deleteAppointment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[deleteAppointment]": async (id)=>{
            await api(`/api/appointments/${id}`, {
                method: "DELETE"
            });
            await fetchAppointments();
        }
    }["AppProvider.useCallback[deleteAppointment]"], [
        fetchAppointments
    ]);
    const cancelAppointment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[cancelAppointment]": async (id)=>{
            await api(`/api/appointments/${id}/cancel`, {
                method: "POST"
            });
            await fetchAppointments();
        }
    }["AppProvider.useCallback[cancelAppointment]"], [
        fetchAppointments
    ]);
    const realignSchedule = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[realignSchedule]": async ()=>{
    ...
    }["AppProvider.useCallback[realignSchedule]"], [
        fetchAppointments
    ]);
    const updateSettingsAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[updateSettingsAction]": async (data)=>{
    ...
    }["AppProvider.useCallback[updateSettingsAction]"], [
        fetchSettings
    ]);
    const changePassword = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[changePassword]": async (currentPassword, newPassword)=>{
    ...
    }["AppProvider.useCallback[changePassword]"], [
        user
    ]);
    const getClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[getClient]": (id)=>clients.find({
                "AppProvider.useCallback[getClient]": (c)=>c.id === id
            }["AppProvider.useCallback[getClient]"])
    }["AppProvider.useCallback[getClient]"], [
        clients
    ]);
    const getCrew = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[getCrew]": (id)=>crews.find({
                "AppProvider.useCallback[getCrew]": (c)=>c.id === id
            }["AppProvider.useCallback[getCrew]"])
    }["AppProvider.useCallback[getCrew]"], [
        crews
    ]);
    const getUnassignedCrew = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[getUnassignedCrew]": async ()=>{
            const crew = await api("/api/crews/unassigned");
            await fetchCrews();
            return crew;
        }
    }["AppProvider.useCallback[getUnassignedCrew]"], [
        fetchCrews
    ]);
    const getAppointment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[getAppointment]": (id)=>appointments.find({
                "AppProvider.useCallback[getAppointment]": (a)=>a.id === id
            }["AppProvider.useCallback[getAppointment]"])
    }["AppProvider.useCallback[getAppointment]"], [
        appointments
    ]);
    const value = {
...
_s(AppProvider, "J2Zflbiyivtb6rfGsvtZSYljfSI=");
_c = AppProvider;
...
function AppSidebar() {
    ...
    const { user, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$app$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppState"])();
    const handleLogout = ()=>{
        logout();
        router.push("/login");
    };
...
_s(AppSidebar, "WwMl6hpDVubVLrea+PhqbMe9RuE=", false, function() {
    return [
...
//# sourceMappingURL=_8359235d._.js.map