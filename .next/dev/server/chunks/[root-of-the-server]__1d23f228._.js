...
async function POST(req, { params }) {
    try {
        ...
        const member = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].crewMember.create({
            data: {
                crewId: id,
                name: body.name,
                role: dbRole,
...
async function GET(req, { params }) {
    try {
        const { id } = await params;
        const members = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].crewMember.findMany({
            where: {
                crewId: id
            },
            orderBy: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1d23f228._.js.map