...
"[project]/lib/time-utils.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function shouldBeLocked(scheduledDate) {
    const now = new Date();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$time$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/time-utils.ts [app-route] (ecmascript)");
;
;
;
async function GET(req) {
    try {
        ...
        appointments.forEach((apt)=>{
            if (!apt.isLocked && (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$time$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["shouldBeLocked"])(apt.scheduledDate, apt.startTime, now)) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7007490a._.js.map